    ...
    return (
        <main className="min-h-screen bg-[#050505] text-white">
            ...
            <div className="fixed inset-0 z-0 pointer-events-none">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-[#00A5FF] opacity-[0.02] blur-[200px] rounded-full hidden md:block" />
            </div>

            <div className="relative z-10 max-w-7xl mx-auto px-4 py-16 md:py-24">
                {/* Header */}
                <div className="mb-12">
                    <p className="text-xs uppercase tracking-[0.4em] text-[#00A5FF]/60 mb-3">{t('subtitle')}</p>
                    <h1
                    ...
                    <div className="h-px w-64 bg-gradient-to-r from-[#00A5FF] to-transparent mt-5" />
