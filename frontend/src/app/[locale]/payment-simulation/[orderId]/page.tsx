...
export default function PaymentSimulationPage() {
    ...
    return (
        <div className="min-h-[80vh] flex flex-col items-center justify-center p-4">
            <div className="bg-[#0A0A0A] border border-[#00A5FF]/30 p-8 md:p-12 rounded-sm shadow-[0_0_40px_rgba(0,165,255,0.1)] flex flex-col items-center max-w-xl w-full text-center">
                ...
                <div className="flex gap-4 mb-8">
                    ...
                    <div className="w-16 h-16 bg-[#111] rounded-full border border-[#00A5FF]/50 flex items-center justify-center">
                        <ShieldCheck size={32} className="text-[#00A5FF]" />
                    </div>
                </div>
                ...
                <button
                    ...
                    className={`
                        ...
                        ${isSimulating
                            ...
                            : 'bg-gradient-to-r from-[#008ecc] via-[#00A5FF] to-[#3498db] btn-gold-safe text-black shadow-[0_0_20px_rgba(0,165,255,0.3)] hover:scale-[1.02] btn-gold-safe'
                        }
                    `}
                    style={{ 
