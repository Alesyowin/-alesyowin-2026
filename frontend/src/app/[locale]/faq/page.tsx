        ...
        <div className="min-h-screen bg-black text-white font-sans py-20 px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-black border border-white/5 rounded-2xl p-8 md:p-12 mb-12 shadow-2xl">
                    <p className="text-lg leading-relaxed text-white whitespace-pre-wrap italic opacity-90 text-center">
                        {t('intro')}
                    </p>
                </div>
                ...
                <div className="space-y-8">
                    {questionKeys.map((key) => (
                        <div key={key} className="bg-[#0a0a0a] border border-white/5 rounded-2xl p-6 md:p-8 hover:border-(--color-gold)/30 transition-all duration-300 group">
                            <h3 className="text-xl md:text-2xl font-bold text-[#00A5FF] mb-4 flex gap-4">
                                <span className="opacity-30 group-hover:opacity-100 transition-opacity">?</span>
                                {t(`sections.${key}.question`)}
                            </h3>
                            <div className="text-white leading-relaxed text-lg border-l-2 border-(--color-gold)/20 pl-6 ml-2 italic">
